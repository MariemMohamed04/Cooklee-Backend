    ...
    public partial class m1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DisplayName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IdImgURL = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChefPage", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientMeal", x => new { x.MealsId, x.clientsId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientMeals", x => new { x.ClientId, x.MealId, x.Id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChefPage_ClientId",
                table: "ChefPage",
                column: "ClientId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ClientMeal_clientsId",
                table: "ClientMeal",
                column: "clientsId");

            migrationBuilder.CreateIndex(
                name: "IX_ClientMeals_MealId",
                table: "ClientMeals",
                column: "MealId");
